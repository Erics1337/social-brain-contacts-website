				...
				<div className='flex flex-col md:flex-row items-center'>
					<div className='w-full md:w-1/2 flex flex-col justify-center items-center md:items-start text-center md:text-left'>
						...
						<p className='text-lg md:text-xl mb-6 py-4'>
							Experience our innovative app and contribute to its
							development! Download the app now and share your
							feedback to help us improve and refine our product.
						</p>
						...
						<ol className='list-decimal list-inside mb-6 text-lg md:text-xl'>
							...
							<li>
								After exploring the app, share your experience
								and suggestions by filling out the{' '}
								<a
